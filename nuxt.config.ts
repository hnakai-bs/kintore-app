  ...
  app: {
    head: {
      ...
      meta: [
        ...
        { name: "application-name", content: "RE-BIRTH" },
        { name: "apple-mobile-web-app-title", content: "RE-BIRTH" },
        { name: "apple-mobile-web-app-capable", content: "yes" },
      ],
      link: [
        { rel: "manifest", href: "/site.webmanifest" },
        { rel: "icon", type: "image/png", href: "/daiki-fit_2.png" },
        { rel: "apple-touch-icon", href: "/daiki-fit_2.png" },
      ],
    },
  },
  css: [
